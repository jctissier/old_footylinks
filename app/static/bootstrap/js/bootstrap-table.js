...
! function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Showing %s to %s of %s Matches', pageFrom, pageTo, totalRows);
        },
        formatSearch: function () {
            return 'Search Highlights...';
        },
        formatNoMatches: function () {
            return 'No recent matches with your search';
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search" style="padding-right: 20px;">',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('<span class="page-list" style="display: none;">');
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    if (value.includes('<p') && that.options.cardView){
                        value = value.replace("<p", "<span").replace("</p>", "</span>");
                    }  
    ...
    BootstrapTable.prototype.resetFooter = function () {
        ...
        $.each(this.columns, function (i, column) {
            ...
            html.push('<td', class_, sprintf(' style="%"', falign + style), '>');
